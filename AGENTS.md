...
## PSEO Pages
- **64 bank pages** at `/bank/[slug]` — each with BankOrCreditUnion, FAQPage, HowTo, BreadcrumbList schema
- **7 category pages** at `/banks/[category]` — CollectionPage + ItemList schema
- **7 vertical routes** — `/customer-care/[slug]`, `/net-banking/[slug]`, `/sms-banking/[slug]`, `/mini-statement/[slug]`, `/mobile-number-registration/[slug]`, `/aadhaar-link/[slug]`, `/atm-pin/[slug]` — each with 64+ pages
